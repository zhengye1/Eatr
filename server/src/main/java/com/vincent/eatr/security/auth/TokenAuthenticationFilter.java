package com.vincent.eatr.security.auth;
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
  ...
  private List<String> pathsToSkip = Arrays.asList(ROOT_MATCHER, HTML_MATCHER, FAVICON_MATCHER,
      CSS_MATCHER, JS_MATCHER, IMG_MATCHER, LOGIN_MATCHER, LOGOUT_MATCHER);
